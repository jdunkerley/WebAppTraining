(function() {
    ...
    quandlServices.factory('DatasetsList', ['$resource',
        function ($resource) {
            return $resource('https://www.quandl.com/api/v3/datasets.json?query=:query&database_code=WIKI&per_page=:perPage&page=:page', {}, {
            //Provide your key
        ...
        function ($resource) {
            return $resource('https://www.quandl.com/api/v3/datasets/WIKI/:code/data.json?start_date=2014-01-01', {}, {
            //Provide your key
